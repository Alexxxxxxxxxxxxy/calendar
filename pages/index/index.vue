<script setup>
import client from "../../public/client-o.png"
import coin from "../../public/Coin.png"
import { ref } from 'vue';

import Progress from "@/components/Progress.vue"

const img = ref(client)
...
<template>
	<view class="main">
		<view class="dum">
			<image :src="img" class="dum-point1"/>
			<view class="dum-point2">
				<image :src="coin" class="coin"/>
		...
		<view class="fun">
			<view class="check" @click="todayJump">
				<view>查看</view>
				<view>今日计划</view>
			</view>
			<view class="skill">
